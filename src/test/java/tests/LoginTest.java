...
public class LoginTest extends TestBase {
	...
	public void validateMyPersonalInformation() throws InterruptedException, IOException, ParseException {
		...
		// Wait for login page to load and check for cookie consent button

		softAssertion.assertEquals(loginpage.isLoaded(), true, "Login page did not load successfully");
